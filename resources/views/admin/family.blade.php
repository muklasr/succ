                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:150px">
                                    ...
                                    <a href="/admin/family/delete/{{ $data->id }}" class="btn btn-danger btn-flat">
                                        <span class="icon text-white-50">
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('familyAdd') }}" id="form">
...
<script>
    ...
    $('.btnEdit').click(function() {
        var id = $(this).data('id');
        $.get('/admin/family/edit/' + id, function(data) {
            $('.modal-title').html("Edit Family");
